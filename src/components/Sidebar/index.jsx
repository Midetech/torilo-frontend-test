...
const Sidebar = () => {
  return (
    <div className="w-[260px] bg-white relative pt-10 top-12 flex item-center flex-col  gap-5 ">
      <button className="h-[33px] w-[163px] bg-[#27AE60] rounded-[30px] text-white uppercase font-bold ml-5">
        Generate Invoice
      </button>
              ...
              <div
                ...
                className={` ${
                  item.section === "Main" && index === 0
                    ...
                    : ""
                } flex items-center gap-3 h-[30px] hover:h-[30px] hover:p-5  p-5 hover:border-l-[4px]  hover:border-[#1875F0] pl-5 hover:pl-5 cursor-pointer hover:bg-[#1875F0] hover:bg-opacity-[0.1]`}
              >
